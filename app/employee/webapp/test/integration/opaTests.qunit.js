...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "demo/em/employee/test/integration/FirstJourney",
    "demo/em/employee/test/integration/EmployeesListJourney",
    "demo/em/employee/test/integration/EmployeesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
